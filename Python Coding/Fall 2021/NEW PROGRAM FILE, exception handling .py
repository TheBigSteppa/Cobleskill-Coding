...
# Mark's comments to the professor:
# I identified and handled 3 different exceptions on this file
# IOError, ValueError, and IndexError.
...
# delete the requested item from the list// Also added the IndexError here, my total exceptions for this are 3
try:
    del inventory[itemToDelete]
except IndexError as e2:
    print("\nYour input is not a valid entry\n")
    print("\"",e2,"\"")
    input("\nPress enter to Quit")
    sys.exit()
